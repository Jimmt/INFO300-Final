...
## Results
The first step of constructing a relationship between pay and time for three-point specialists was to perform exploratory data analysis. Given the criteria mentioned above, these were the number of specialists for each year:
```{r echo=FALSE, warning=FALSE}
export(specialists.over.time)
```

```{r echo=FALSE, warning=FALSE}
export(salary.over.time)
```
